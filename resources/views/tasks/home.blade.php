...
<div class="content-card">
    ...
    {{-- ── Top Bar: Dashboard + Search + Add Task ── --}}
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-4 col-lg">
            <a href="{{ route('tasks.index', ['status' => 'In Progress']) }}" class="text-decoration-none d-block h-100">
    ...
    @if($tasks->isEmpty())
        <div class="text-center py-5">
            ...
            <p class="mt-3 text-muted fs-5">No tasks yet. <a href="#" data-bs-toggle="modal" data-bs-target="#addTaskModal">Add your first task</a>.</p>
        </div>
    @else
        @php
        ...
        <table class="table task-table table-hover mb-0" id="taskTable">
            ...
            <tbody id="taskBody">
                @foreach($tasks as $index => $task)
                    <tr data-name="{{ strtolower($task->task_name) }}"
        ...
        <div class="d-flex align-items-center justify-content-between mt-3 flex-wrap gap-2">
            <p class="text-muted mb-0 small">
                <span id="filteredText" class="d-none">Showing <strong id="visibleCount"></strong> matching tasks on this page.</span>
...
(function () {
    ...
    function applyFilters() {
        ...
        // Handle pagination text vs filtered text
        const isFiltering = name !== '' || priority !== '' || status !== '';
        if (isFiltering) {
            document.getElementById('paginationText').classList.add('d-none');
            document.getElementById('filteredText').classList.remove('d-none');
            if (visibleCount) visibleCount.textContent = visible;
        } else {
            document.getElementById('paginationText').classList.remove('d-none');
            document.getElementById('filteredText').classList.add('d-none');
        }
